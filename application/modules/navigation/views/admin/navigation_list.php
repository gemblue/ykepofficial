    ...
    <li class="my-1 <?= $link['status']; ?>" data-order="<?= $link['nav_order']; ?>">
        <div class="navrow py-1 px-2">
            ...
            <div class="text-right pull-right">
                <div class="option">
                    <a href="<?= site_url("admin/navigation/swap_link_order/{$link['nav_order']}/{$link['area_id']}/up"); ?>" class="btn btn-sm btn-primary sort-scroll-button-up" data-area="<?= $area; ?>"><i class="fa fa-arrow-up" title="move up"></i></a>

                    <a href="<?= site_url("admin/navigation/swap_link_order/{$link['nav_order']}/{$link['area_id']}/down"); ?>" class="btn btn-sm btn-primary sort-scroll-button-down" data-area="<?= $area; ?>"><i class="fa fa-arrow-down" title="move down"></i></a>
