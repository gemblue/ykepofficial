...
class Post_model extends CI_Model
{
	...
	public function getPost($status = null, $by_field, $by_field_value, $output = 'stdClass')
	{
    ...
    {
        $meta_table = $this->posttype[$post_type]['table'] ?? null;
	...
	public function insert($param)
	{
        ...
        if (empty($param['featured_image']))
            $param['featured_image'] = 'http://codepolitan.local/themes/belajarcoding/assets/img/default-thumb.jpg';
