...
<style type="text/css">
	...
	#ci-profiler-menu-open.bottom-right { position: fixed; right: -2px; bottom: 5px; }
	...
	#ci-profiler-console pre {color:white !important; background-color: black; border: 0;}
</style>
...
<a href="#" id="ci-profiler-menu-open" class="<?php echo $bar_location ?>" onclick="ci_profiler_bar.open(); return false;" style="width: 2em;text-decoration: none;">&nbsp;</a>
